...
public class DataConstants {
	   ...
	   private static final String APP_PACKAGE_NAME = "com.tax.droidpropa";
	   private static final String EXTERNAL_DATA_DIR_NAME = "droidpropa";
	   public static final String DATABASE_NAME = "droidpropa.db";
	   ...
	   public static final String EXPORT_FILENAME = "droidpropa.csv";
