...
public class AppuntiExport
{
	private static final String EXPORT_FILE_NAME = "/sdcard/DroidPropa/export.xml";

	private Context _ctx;
	private SQLiteDatabase _db;
	private Exporter _exporter;

	public AppuntiExport( Context ctx, SQLiteDatabase db )
	{
		_ctx = ctx;
		_db = db;
...
//		}
	...
	class Exporter
	{
		...
		public void addColumn( String name, String val ) throws IOException
		{
			...
			String stg = START_COL + name + CLOSING + val + END_COL + name + CLOSING;
